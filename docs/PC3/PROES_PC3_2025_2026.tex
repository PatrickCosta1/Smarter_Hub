...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.94\linewidth]{smarter_hub_casos_de_uso_resumo.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.94\linewidth]{smarter_hub_arquitetura_completa.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.94\linewidth]{smarter_hub_modelo_dados_completo.png}
  \caption{Modelo de dados essencial do SMARTER HUB (versão completa).}
