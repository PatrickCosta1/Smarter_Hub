...
describe('Profile HTTP validation integration', () => {
  ...
  it('validates profile data consistency between frontend and backend', () => {
    ...
    const profileData = {
      ...
      situacaoIrs: 'Casado',
      numeroDependentes: '0',
      declaracaoIrs: 'Declaração IRS 2025',
      irsJovem: 'Não',
      anoPrimeiroDesconto: '2020',
      comprovativoMoradaFiscal: '/uploads/comprovativo-morada.pdf',
      comprovativoCartaoCidadao: '/uploads/cc.pdf',
      comprovativoIban: '/uploads/iban.pdf',
      comprovativoCartaoContinente: '/uploads/continente.pdf',
      photoUrl: '/uploads/photo.jpg',
      certificadoHabilitacoesUrl: '/uploads/certificado.pdf',
      cartaConducaoUrl: '/uploads/carta.pdf',
      criminalRecordUrl: '/uploads/registo-criminal.pdf',
